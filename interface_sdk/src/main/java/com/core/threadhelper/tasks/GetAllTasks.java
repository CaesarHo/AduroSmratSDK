...
//                            System.out.println("task_no = " + task_no );
                    ...
                    for (int i = 0; i < task_cmd_data.length; i++) {
                        ...
                        System.out.println("data_mian_point_1 = " + data_mian_point_1);
                ...
                if (task_no != 0 | task_name != null){
                    ...
                    appTask.setSerial_type1(serial_type1);
                    appTask.setAction_state1(action_state1);
                    appTask.setAction_state6(action_state6);

                    appTask.setSerial_type2(serial_type2);
                    appTask.setAction_state2(action_state1);
                    appTask.setAction_state7(action_state6);

                    appTask.setSerial_type3(serial_type3);
                    appTask.setAction_state3(action_state1);
                    appTask.setAction_state8(action_state6);

                    appTask.setSerial_type4(serial_type4);
                    appTask.setAction_state4(action_state1);
                    appTask.setAction_state9(action_state6);

                    appTask.setSerial_type5(serial_type5);
                    appTask.setAction_state5(action_state1);
                    appTask.setAction_state10(action_state6);
