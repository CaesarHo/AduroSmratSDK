...
public class CreateTimingDeviceTask implements Runnable{
    ...
    public CreateTimingDeviceTask(String task_name, byte is_run,byte task_cycle, int task_hour, int task_minute,
    ...
    public void run() {
        try {
            ...
            this.bt_send = TaskCmdData.CreateTimingDeviceTaskCmd(task_name,is_run,task_cycle,task_hour, task_minute,
