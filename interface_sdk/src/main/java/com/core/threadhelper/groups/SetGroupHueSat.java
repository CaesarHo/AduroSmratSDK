 ...
 */
public class SetGroupHueSat implements Runnable {
    ...
    public SetGroupHueSat(String ipaddress, int port, Short groupId, byte hue, byte sat){
...
//            repdata.parseBytes(packet.getData());
            ...
            DataSources.getInstance().setGroupHueSat((short)123456,(byte)1,(byte)2);
            m_CMDSocket.close();
        } catch (Exception e) {
