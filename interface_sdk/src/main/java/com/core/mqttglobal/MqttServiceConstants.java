...
interface MqttServiceConstants {
    ...
    static final String CALLBACK_TO_ACTIVITY = MqttService.TAG + ".callbackToActivity" + "." + VERSION;
    ...
    static final String CALLBACK_CLIENT_HANDLE = MqttService.TAG + "." + CLIENT_HANDLE;
    static final String CALLBACK_ERROR_MESSAGE = MqttService.TAG + ".errorMessage";
    static final String CALLBACK_EXCEPTION_STACK = MqttService.TAG + ".exceptionStack";
    static final String CALLBACK_INVOCATION_CONTEXT = MqttService.TAG + "." + "invocationContext";
    static final String CALLBACK_ACTIVITY_TOKEN = MqttService.TAG + "." + "activityToken";
    static final String CALLBACK_DESTINATION_NAME = MqttService.TAG + '.' + DESTINATION_NAME;
    static final String CALLBACK_MESSAGE_ID = MqttService.TAG + '.' + MESSAGE_ID;
    static final String CALLBACK_MESSAGE_PARCEL = MqttService.TAG + ".PARCEL";
    static final String CALLBACK_TRACE_SEVERITY = MqttService.TAG + ".traceSeverity";
    ...
    static final String CALLBACK_ERROR_NUMBER = MqttService.TAG + ".ERROR_NUMBER";
