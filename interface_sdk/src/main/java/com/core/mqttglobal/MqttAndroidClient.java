...
public class MqttAndroidClient extends BroadcastReceiver implements IMqttAsyncClient {
    ...
    private static final String SERVICE_NAME = "com.mqttglobal.MqttService";
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message)throws MqttException, MqttPersistenceException {
        Log.i("MQTTpublish = " ,topic + message.toString());
    ...
    public IMqttDeliveryToken publish(String topic,byte[] payload,int qos,boolean retained,
        ...
        Log.i("MQTTpublish byte = " ,topic + clientHandle + message.toString());
        return token;
    }
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message, Object userContext, IMqttActionListener callback)
        ...
        token.setDelegate(internalToken);
        Log.i("MQTTpublish = " ,topic + clientHandle + message.toString());
        return token;
    }
    ...
    public IMqttToken subscribe(String topic, int qos, Object userContext,IMqttActionListener callback) throws MqttException {
        ...
        Log.i("MQTTsubscribe = " ,topic + clientHandle);
        return token;
    }
    ...
    public IMqttToken unsubscribe(String topic, Object userContext,IMqttActionListener callback)throws MqttException {
        ...
        Log.i("MQTTunsubscribe = " ,topic + clientHandle);
        return token;
    }
