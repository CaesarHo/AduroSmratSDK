 ...
 */
public class SendandReceiveOnModifyDevice implements Runnable {
    ...
    public SendandReceiveOnModifyDevice(String ipaddress, int port, String devicename, int deviceid){
...
//            repdata.parseBytes(packet.getData());
            ...
            DataSources.getInstance().ModifyDeviceResult(1);
        } catch (Exception e) {
