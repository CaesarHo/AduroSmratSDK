 ...
 */
public class SendandReceiveOnAddRoom implements Runnable{
    Context context;
    ...
    public SendandReceiveOnAddRoom(Context context, String ipaddress, int port, String roomname, String roomid){
...
//            repdata.parseBytes(packet.getData());
            ...
            DataSources.getInstance().AddRoomResult(1);
        } catch (Exception e) {
