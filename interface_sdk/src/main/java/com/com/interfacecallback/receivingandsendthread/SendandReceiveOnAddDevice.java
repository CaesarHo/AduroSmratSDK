 ...
 */
public class SendandReceiveOnAddDevice implements Runnable{
    Context context;
    ...
    public SendandReceiveOnAddDevice(Context context, String ipaddress, int port, String devicename, int deviceid){
