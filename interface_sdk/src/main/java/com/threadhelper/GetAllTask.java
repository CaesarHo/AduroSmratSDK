...
public class GetAllTask implements Runnable {
    ...
    public String action_device_mac;
    ...
    public void run() {
        try {
            ...
            bt_send = NewCmdData.GetAllTasks();
...
//                            System.out.println("task_no = " + task_no );
                    ...
                    task_action = FtFormatTransfer.hBytesToShort(action_bt);
                    System.out.println("task_action = " + task_action);


                    //产生动作的设备mac
                    action_device_mac = task_str.substring(22, 38);
                    System.out.println("action_device_mac = " + action_device_mac);
                 ...
                 */
                if (task_no != 0 | task_name != null | action_device_mac != null){
                    DataSources.getInstance().getAllTasks(
                            task_no, task_name, task_is_enabled, task_type, task_cycle, task_hour,
                            task_minute, task_action, action_device_mac, task_cmd_size,
