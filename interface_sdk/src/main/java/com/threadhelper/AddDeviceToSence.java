...
public class AddDeviceToSence implements Runnable {
    ...
    public AddDeviceToSence(String ipaddress, int port, Short sencesId, String sencesName, String deviceid,byte delaytime){
...
//            repdata.parseBytes(packet.getData());
            ...
            DataSources.getInstance().AddDeviceToSences("场景名称",123456,(short)123456, 1);
            m_CMDSocket.close();
        }catch (Exception e){
            e.printStackTrace();
        }
