 ...
 */
public class DeleteSenceMember implements Runnable {
    ...
    public DeleteSenceMember(String ipaddress, int port, String sencesName,String deviceid){
...
//            repdata.parseBytes(packet.getData());
            ...
            DataSources.getInstance().DeleteSencesMember(1);
            m_CMDSocket.close();
        }catch (Exception e){
            e.printStackTrace();
        }
